...
def render_plate():
    ...
    # Secondly, columns with two numbers need to be placed. These can potentially have conflicts and
    # will need to be verified with the check_row_numbers() method.

    # Lastly, the singular numbers will need to be placed to make the all the rows have exactly 5 numbers in them.
